// https://www.codewars.com/kata/a-rule-of-divisibility-by-7/train/csharp
  ...
  public static long[] Seven(long number)
    {
      ...
      while (number > 99){
        ++processCount;
        number = processBySeven(number);
      }
      return(new long[] {number, processCount});
    }

    public static long processBySeven (long x){
      return(x / 10 - 2 * (x % 10));
    }
}
